...
export default function InternalUserProfile() {
  ...
  const handleEdit = () => {
    router.push(`/internal/dashboard/edit-internal-profile/${params.id}`);
  };
    ...
    <ExternalLayout>
      <div className="space-y-6 p-6 max-w-[1200px] mx-auto">
        ...
        >
          ...
          <Button
            variant="outline"
            onClick={() => router.push('/internal/dashboard/account')}
        ...
        {/* Profile Header with Edit/Delete Buttons */}
              ...
              <div className="flex gap-3">
                ...
                <AlertDialog>
                  ...
                  <AlertDialogContent className="dark:bg-gray-900 dark:border-gray-800">
                    ...
                    <AlertDialogFooter>
                      <AlertDialogCancel className="dark:bg-gray-800 dark:hover:bg-gray-700">Cancel</AlertDialogCancel>
                      <AlertDialogAction
            ...
            <CardContent className="p-6 space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="font-medium">{user.jobDepartment || '-'}</p>
                </div>
              </div>
            </CardContent>
          </Card>
