...
export function OrganizationChart({ practice }: OrganizationChartProps) {
  ...
  const handleEntityClick = (entityId: string) => {
    ...
    if (practice.associatedEntities) {
      ...
      switch (entityId) {
        case "practitioners":
          filteredEntities = practice.associatedEntities.filter(e => e.entityType?.toUpperCase() === "PRACTITIONER");
          break;
        case "contacts":
        ...
        case "corporate":
          ...
          break;
        case "ehr":
          filteredEntities = practice.associatedEntities.filter(e => e.entityType?.toUpperCase() === "EHR");
          break;
        case "insurance":
          filteredEntities = practice.associatedEntities.filter(e => e.entityType?.toUpperCase() === "INSURANCE");
          break;
      }
