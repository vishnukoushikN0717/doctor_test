...
import { OrganizationChart } from "@/components/Profile/EHROrganizationChart";
    ...
    const fetchPractice = async () => {
      try {
        ...
        const response = await fetch(
          `https://dawaventity-g5a6apetdkambpcu.eastus-01.azurewebsites.net/api/Entity/${params.id}?EntityType=EHR`, 
          {
            method: "GET",
            headers: {
              accept: "*/*",
