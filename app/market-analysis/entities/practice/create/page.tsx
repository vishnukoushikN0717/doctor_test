...
export default function CreatePractice() {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
      ...
      const createdPractice = await response.json();
      const newPracticeId = createdPractice.result.id;
      setPracticeId(newPracticeId);
      setShowSuccessModal(true);
      toast.success("Practice created successfully");
    } catch (error) {
      const errorMessage = (error as Error).message || "Failed to create practice";
      console.error("Error creating practice:", errorMessage);
  ...
  const handleClosePopup = () => {
    ...
    router.push("/market-analysis/entities/practice/landing");
  };
  ...
  return (
    <div className="space-y-6 pb-8">
      <div className="border-b pb-4">
        ...
        <h1 className="text-2xl font-semibold mt-2">Create Practice</h1>
        <p className="text-sm text-muted-foreground mt-1">
          Fill in the details below to create a new practice entity
        </p>
      </div>
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="flex justify-end gap-4 pt-4">
              <Button
                type="button"
                variant="outline"
                onClick={() => router.push("/market-analysis/entities/practice/landing")}
                disabled={isSaving}
