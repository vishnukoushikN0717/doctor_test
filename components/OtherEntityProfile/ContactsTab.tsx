...
export function ContactsTab({ practitioner }: ContactsTabProps) {
  ...
  const contacts = practitioner.associatedEntities?.filter(
      ...
      <AlertDialog open={isUnlinkDialogOpen} onOpenChange={setIsUnlinkDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to unmap {selectedContact?.name} from this practitioner? 
              This action will remove the association between the contact and the practitioner.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
