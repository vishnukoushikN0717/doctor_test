...
export function PracticesTab({ practitioner }: PracticesTabProps) {
  ...
  const practices = practitioner.associatedEntities?.filter(
  ...
  const handleUnlink = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `/api/EntityUnlinking/PRACTITIONER/${practitioner.id}`,
        {
          method: "POST",
          headers: {
      ...
      practitioner.associatedEntities = practitioner.associatedEntities?.filter(
      ...
      <AlertDialog open={isUnlinkDialogOpen} onOpenChange={setIsUnlinkDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to unmap {selectedPractice?.name} from this practitioner? 
              This action will remove the association between the practice and the practitioner.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
